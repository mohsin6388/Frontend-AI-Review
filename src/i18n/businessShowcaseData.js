...
export const BUSINESSES_BY_COUNTRY = {
  IN: [
    ...
    },
    {
      ...
      reviews: 101,
      review:
        "Best Review System to our customer it's easy to take customer feedback",
      customer: "Aryan Singh",
      image:
        "https://lh3.googleusercontent.com/grass-cs/ACvplmNy03FGOh2St9P1opK4VKaaEkvujMVtGGTdmMGfqGOoRsPD2p-RgxhsPVK4rz3-uBCrw11zhC3rn_vTTrCq9lvPzFDvgUOqlon6VgiL1X5Pw5VpFDT2fv_bn6iSmtY8CS4VFALfTBCw8_vI=w326-h312-n-k-no",
    },
    {
      type: "beauty",
      name: "P3 Salon",
    ...
    },
    {
      ...
      reviews: 324,
      review:
        "Great for understanding patient needs and improving reviews with Review Ninja Pro!",
  ...
  US: [
    {
      ...
      rating: 4.7,
      reviews: 76,
      review: "Fantastic for customer reviews to analyze and increase visit.",
    ...
    {
      type: "fitness",
      name: "Grand Slam USA Gym",
      category: "Gym & Fitness",
      rating: 4.8,
      reviews: 95,
      review: "Great for growing our gym and getting more customer reviews!",
    ...
    // { type: "beauty", name: "Luxe Beauty Bar", category: "Beauty & Salon", rating: 4.9, reviews: 298, review: "Left feeling amazing, will definitely be back.", customer: "Sophia Reyes", image: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=500&q=80" },
    {
      ...
      reviews: 909,
      review:
        "Great for understanding patient needs and improving customer reviews with Review Ninja Pro!",
  ...
  GB: [
    {
      ...
      rating: 5,
      reviews: 137,
      review: "Brilliant for improving customer reviews!",
      customer: "Oliver Hughes",
      image: cafe_uk,
    },
    {
      type: "fitness",
      name: "Topnotch Gyms Soho",
      category: "Gym & Fitness",
      rating: 4.8,
      reviews: 368,
      review:
        "Brilliant for growing our gym and getting more customer reviews!",
      customer: "Charlotte Bennett",
      image: gym_uk,
    },
    {
      type: "beauty",
      name: "Unique Hair Studio",
      category: "Beauty & Salon",
      rating: 4.8,
      reviews: 256,
      review:
        "Really pleased with the results—it’s helped increase our sales!, absolutely brilliant.",
    ...
    },
    {
      ...
      reviews: 101,
      review:
        "Brilliant for understanding patient needs and improving customer reviews with Review Ninja Pro!",
      customer: "James Whitfield",
      image: dental_clinic_uk,
    },
  ],
