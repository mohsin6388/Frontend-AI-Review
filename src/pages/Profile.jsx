  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      if (response.status >= 200 && response.status < 300) {
        // Clear authentication state through AuthContext
        logout();
      ...
      <div className="profile-layout">
        ...
        <div className="profile-overview-card">
          <div className="profile-overview-content">
            ...
            <div className="profile-inline-delete">
              <div>
                <span className="profile-inline-delete-label">
                  ACCOUNT ACTION
                </span>
              ...
              <button
                type="button"
                className="delete-account-button profile-inline-delete-button"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
