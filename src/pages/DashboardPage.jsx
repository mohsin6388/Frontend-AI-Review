...
const DashboardPage = () => {
  ...
  const isLimitReached =
    stats?.reviewsLimit !== null && stats?.maxReviews >= stats?.reviewsLimit;
  ...
  return (
    <div className="dash-page-wrapper">
      ...
      <header className="dash-navbar">
        ...
        >
          <span
            className={`hamburger-line ${mobileMenuOpen ? "line1-open" : ""}`}
          />
          <span
            className={`hamburger-line ${mobileMenuOpen ? "line2-open" : ""}`}
          />
          <span
            className={`hamburger-line ${mobileMenuOpen ? "line3-open" : ""}`}
          />
        </button>
        ...
        <div className="dash-nav-right">
          ...
          {!subscriptionLoading && (
            <div className="desktop-subscription">
              {stats?.hasSubscription ? (
                ...
                <div className="dash-usage-pill limit-reached">
                  ...
                  <span className="dash-usage-text">No Subscription</span>
          ...
          {/* USER */}
          <div className="dash-user-pill" onClick={() => goToTab("profile")}>
        ...
        <aside className={`sidebar ${mobileMenuOpen ? "open" : ""}`}>
          ...
          {!subscriptionLoading && (
            <div className="mobile-subscription-section">
              ...
              {stats?.hasSubscription ? (
                <div
                  className={`dash-usage-pill mobile-usage-pill ${
                    isLimitReached ? "limit-reached" : ""
                  }`}
                >
                  <span className="dash-usage-dot" />
                ...
                <div className="dash-usage-pill limit-reached mobile-usage-pill">
                  <span className="dash-usage-dot" />
                  <span className="dash-usage-text">No Subscription</span>
